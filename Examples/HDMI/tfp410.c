...
// LCD configuration
// 800 * 600 * 60 Hz @ LCD_CLK = 36 MHz (72 / 2)
static const LCD_CFG_Type lcdCfg = {
	LCD_WIDTH,                  /* Pixels per line */
	LCD_HEIGHT,                 /* Lines per panel */
	{50,50},                    /* porch setting for horizontal */
	{8,8},                      /* porch setting for vertical */
	60,                         /* HSYNC pulse width in clocks */
	9,                          /* VSYNC pulse width in clocks */
...
//    uint32_t dotclk, pcd;
    ...
    CGU_SetDIV(CGU_CLKSRC_IDIVE, CGU_GetPCLKFrequency(CGU_PERIPHERAL_M3CORE) / 36000000UL);
